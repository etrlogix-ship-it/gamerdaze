#!/usr/bin/env python3
"""
Terraria Server Launcher - Project 04
Helps you set up and run a Terraria dedicated server.
"""
...
STEAM_APPID  = "105600"
DEFAULT_PORT = 7777
SERVER_DIR   = os.path.expanduser("~/04_terraria_server_files")
...
def install_server():
    ...
    print(f"  Installing Terraria server via SteamCMD...")
...
def main():
    print("=" * 48)
    print(f"  Terraria Server Launcher")
    print("=" * 48)
