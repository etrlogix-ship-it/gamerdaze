#!/usr/bin/env python3
"""
Stardew Valley Server Launcher - Project 14
Helps you set up and run a Stardew Valley dedicated server.
"""
...
STEAM_APPID  = "413150"
DEFAULT_PORT = 24642
SERVER_DIR   = os.path.expanduser("~/14_stardew_server_files")
...
def install_server():
    ...
    print(f"  Installing Stardew Valley server via SteamCMD...")
...
def main():
    print("=" * 48)
    print(f"  Stardew Valley Server Launcher")
    print("=" * 48)
