#!/usr/bin/env python3
"""
Factorio Server Launcher - Project 07
Helps you set up and run a Factorio dedicated server.
"""
...
STEAM_APPID  = "427520"
DEFAULT_PORT = 34197
SERVER_DIR   = os.path.expanduser("~/07_factorio_server_files")
...
def install_server():
    ...
    print(f"  Installing Factorio server via SteamCMD...")
...
def main():
    print("=" * 48)
    print(f"  Factorio Server Launcher")
    print("=" * 48)
