#!/usr/bin/env python3
"""
Satisfactory Server Launcher - Project 11
Helps you set up and run a Satisfactory dedicated server.
"""
...
STEAM_APPID  = "1690800"
DEFAULT_PORT = 7777
SERVER_DIR   = os.path.expanduser("~/11_satisfactory_server_files")
...
def install_server():
    ...
    print(f"  Installing Satisfactory server via SteamCMD...")
...
def main():
    print("=" * 48)
    print(f"  Satisfactory Server Launcher")
    print("=" * 48)
