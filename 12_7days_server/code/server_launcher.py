#!/usr/bin/env python3
"""
7 Days to Die Server Launcher - Project 12
Helps you set up and run a 7 Days to Die dedicated server.
"""
...
STEAM_APPID  = "294420"
DEFAULT_PORT = 26900
SERVER_DIR   = os.path.expanduser("~/12_7days_server_files")
...
def install_server():
    ...
    print(f"  Installing 7 Days to Die server via SteamCMD...")
...
def main():
    print("=" * 48)
    print(f"  7 Days to Die Server Launcher")
    print("=" * 48)
