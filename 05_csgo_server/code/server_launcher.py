#!/usr/bin/env python3
"""
CS2 Server Launcher - Project 05
Helps you set up and run a CS2 dedicated server.
"""
...
STEAM_APPID  = "730"
DEFAULT_PORT = 27015
SERVER_DIR   = os.path.expanduser("~/05_csgo_server_files")
...
def install_server():
    ...
    print(f"  Installing CS2 server via SteamCMD...")
